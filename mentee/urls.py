...
urlpatterns = [
    ...
    path("blog/", mentor.blogs, name="blogs"),
    path("blog/<str:slug>/", mentor.blogs_comments, name="blogs_comments"),
    path("add_blogs/", mentor.add_blogs, name="add_blogs"),
    path("edit_blog_post/<str:slug>/", mentor.UpdatePostView.as_view(), name="edit_blog_post"),
    path("delete_blog_post/<str:slug>/", mentor.Delete_Blog_Post, name="delete_blog_post"),
    path("search/", mentor.search, name="search"),
