...
from .models import Mentee, Mentor, UserInfo, BlogPost
...
class UserInfoForm(forms.ModelForm):
    ...
    interest = forms.ChoiceField(required=True, widget=forms.RadioSelect(
        attrs={'class': 'Radio'}), choices=(('full Stack Development', 'Full Stack Development'), ('artificial Intelligence', 'Artificial Intelligence'),))
